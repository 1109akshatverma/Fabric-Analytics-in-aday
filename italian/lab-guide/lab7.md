...
- Usare la modalità Direct Lake che comporta l'aggiornamento automatico
  dei dati
...
5. Si aprirà la schermata **Creare il primo report**. Saranno
    disponibili opzioni per creare un report usando Excel o il formato
    csv, per immettere dati manualmente o per selezionare un modello
    semantico pubblicato. Abbiamo creato un modello semantico nei lab
    precedenti, quindi possiamo usarlo. Selezionare l'opzione
    **Selezionare un modello semantico pubblicato**.
...
8. Power BI avvierà la creazione automatica del report. Quando il
    ...
    **Checkpoint:** il report sarà simile a quello illustrato nello
...
6. Se non lo si è ancora aperto, aprire il file **FAIAD.pbix**
...
8. Selezionare il menu a discesa **Colore**. Si apre la finestra di
...
17. Aggiungiamo un altro indicatore KPI. Selezionare la **scheda con più
...
7. Nel riquadro **Proprietà** a destra espandere la sezione
    **Avanzate**.
...
10. Nel **riquadro Dati** a destra espandere la tabella **Date**. Notare
    che Year non è un campo di somma.

11. Con l'**oggetto visivo grafico a linee selezionato**, **rimuovere
...
11. Tornare alla **finestra/scheda del report** del browser. Si noti che
...
3. Si apre la finestra di dialogo dell'hub dei dati OneLake.
...
7. Se non lo si è ancora fatto, aprire il file **FAIAD.pbix** contenuto
...
5. Dal **riquadro Explorer** a sinistra selezionare i **puntini di
...
7. Viene visualizzata la finestra di dialogo Nuovo collegamento. In
    **Origini esterne** selezionare **Azure Data Lake Storage Gen2**.

    ![](../media/lab-7/image47.png)

8. Poiché è stata creata una connessione in precedenza nei lab, non è
    necessario crearne una nuova e la connessione ADLS è presente tra
    quelle esistenti.

9. Se in precedenza non è stata creata alcuna connessione, fare clic su
...
12. Verrà stabilita una connessione ad ADLS Gen2 con la struttura delle
...
15. Si verrà indirizzati alla finestra di dialogo successiva, dove
...
17. Selezionare il **segno di spunta** accanto al nome per salvare la
    modifica.
...
18. Selezionare **Crea**.
    ...
    Notare che nel **riquadro Explorer** a sinistra ora è presente la
    tabella InvoicesMay. Ora è necessario aggiornare la vista Sales.

19. In **alto a destra** della schermata selezionare **Lakehouse ->
...
23. Selezionare **rpt_Sales_Report** nella barra dei menu di sinistra
    per tornare al report**.**

24. Nel menu in alto selezionare **Aggiorna**. Notate ora che nel
    ...
    Non è necessario aggiornare il modello di dati e il report quando i dati
    ...
    per adattarsi ai diversi tempi di aggiornamento delle diverse origini
    dati.**
    ...
    necessario eseguire un aggiornamento completo ogni volta per acquisire
    ...
    Spesso il file dei dipendenti non viene caricato in tempo e ciò causa
    l'interruzione dell'aggiornamento del set di dati.**
