...
1. Aprire il **browser** e andare al [portale di Microsoft Power
    ...
    > **Nota:** se non si usa l'ambiente lab e si dispone di un account Power BI esistente, potrebbe essere opportuno usare il browser in modalità privata o in incognito.
...
9. Si apre la finestra di dialogo Attiva la capacità della versione di
    ...
    **Attiva**.
    ...
    > **Nota:** lascia l'area impostata sull'impostazione predefinita. Il docente fornirà maggiori dettagli al riguardo durante la revisione del lab
...
4. Nel campo **Nome** immettere FAIAD_UserID (disponibile nella scheda
    ...
    > verde e che sia indicato "Questo nome è disponibile".*
...
8. Selezionare **Applica** per creare una nuova area di lavoro.
    ...
    passaggio consiste nel creare un lakehouse e lo faremo a breve.
...
3. Si apre una finestra di dialogo Nuovo lakehouse. Immettere
    **lh_FAIAD** nella casella di testo Nome.
    ...
    > molto interessante, quindi è qualcosa di cui dovresti essere a
    > conoscenza. Poiché si tratta di una funzionalità in **Anteprima**, per
    > il momento non la prendiamo in considerazione per evitare qualsiasi
    > impatto negativo sull'esperienza del lab. Quando la funzionalità sarà
...
3. Si apre la home page di Data Factory. Di seguito è riportata una
    ...
    **Tipi di elemento**
    ...
    g. **Oracle con mirroring (anteprima):** il mirroring in Fabric replica
    ...
    h. **Big Query Google con mirroring (anteprima):** il mirroring in
    ...
    i. **Libreria di variabili (anteprima):** contiene un elenco di
    variabili e i relativi valori predefiniti. Può contenere anche altri
    set di valori che includono valori alternativi
...
2. Si apre la home page di Real-Time Intelligence. Di seguito è
    ...
    **Tipi di elemento**
    ...
    g. **Generatore di gemelli digitali (anteprima):** il generatore di
    ...
    h. **Mappa (anteprima):** trasferisci informazioni dettagliate
    ...
    **Per iniziare**
    ...
    c. **Esplora un esempio Eventhouse:** fai clic sul pulsante
    "Seleziona" per imparare a usare Real-Time Intelligence tramite un
    esempio.
...
2. Si apre la home page di Data Warehouse. Di seguito è riportata una
    ...
    **Tipi di elemento**
    ...
    l. **Database SQL di Azure gestiti con mirroring:** consente di
...
2. Si apre la home page di Databases. Di seguito è riportata una
    ...
    **Tipi di elemento**
    ...
    carico di lavoro Databases e i dati sono accessibili da altri
    elementi in Fabric. I dati del database SQL vengono anche mantenuti
    aggiornati in un formato che consente di eseguire query in OneLake,
    in modo che sia possibile usare tutti i diversi servizi in Fabric,
    come l'esecuzione di analisi con Spark, l'esecuzione di notebook e
    di ingegneria dei dati, la visualizzazione tramite report Power BI e
    altro ancora.
