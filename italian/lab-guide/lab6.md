...
1. Torniamo all'area di lavoro di Fabric FAIAD_<nome utente> creata
...
2. Nel menu del riquadro Risultati, seleziona l'icona del menu a
    discesa -> **Visualizza risultati**.
...
1. Seleziona **Lakehouse** per passare alla visualizzazione Lakehouse
    dall'endpoint di analisi SQL.

    ![](../media/lab-6/image13.png)

2. Nel menu selezionare **Nuovo modello semantico.**

    ![](../media/lab-6/image14.png)

3. Viene visualizzata la finestra di dialogo Nuovo modello semantico.
    Immettere **sm_FAIAD** come nome del modello semantico Direct Lake.

4. Per impostazione predefinita abbiamo la possibilità di selezionare
...
5. **Selezionare** le seguenti tabelle/viste:
...
Se non ti trovi attualmente all'interno del nuovo modello semantico
creato, andiamo nel punto corretto
...
5. Creiamo una relazione tra le tabelle Sales e Reseller. Selezionare
    **ResellerID** dalla tabella **Sales** e trascinarlo su
    **ResellerID** nella tabella **Reseller**.

    ![](../media/lab-6/image21.png)

6. Si apre la finestra di dialogo Nuova relazione. Assicurarsi che **Da
    tabella** sia **Sales** e che la **Colonna** sia **ResellerID.**

7. Assicurarsi che **Nella tabella** sia **Reseller** e che la
...
11. Allo stesso modo, creiamo una relazione tra le tabelle Sales e Date.
    Selezionare **InvoiceDate** dalla tabella **Sales** e trascinarlo su
    **Date** nella tabella **Date**.

12. Si apre la finestra di dialogo Nuova relazione. Assicurarsi che **Da
    tabella** sia **Sales** e che la **Colonna** sia **InvoiceDate.**

13. Assicurarsi che **Nella tabella** sia **Date** e che la **Colonna**
    sia **Date.**

14. Assicurarsi che il campo **Cardinalità** sia impostato su **Molti a
    uno (*:1)**.

15. Assicurarsi che il campo **Direzione filtro incrociata** sia
    impostato su **Singola**.
...
17. Analogamente, creare una relazione **molti-a-uno** tra le tabelle
...
15. Si apre la finestra di dialogo Nuova relazione. Assicurarsi che **Da
...
18. Assicurarsi che la **direzione filtro incrociata** sia **Entrambe**.

19. Selezionare **Salva**.

    ![](../media/lab-6/image32.png)

20. Ora creeremo una relazione tra Customer e Reseller. Selezionare **+
    Nuova relazione**.
...
24. Assicurarsi che la **direzione filtro incrociata** sia **Singola**.
