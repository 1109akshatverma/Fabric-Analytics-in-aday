...
2. Wählen Sie im Menü des Bereichs „Ergebnisse" das Dropdown-Symbol ->
    **Ergebnisse visualisieren** aus.
...
2. Wählen Sie im Menü **Neues semantisches Modell** aus

    ![](../media/lab-6/image13.png)

3. Das Dialogfeld „Neues semantisches Modell" wird geöffnet. Geben Sie
    **sm_FAIAD** als Name des Direct Lake-Semantikmodells ein.

4. Wir haben standardmäßig die Möglichkeit, eine Teilmenge der Tabellen
...
5. **Wählen Sie** die folgenden Tabellen/Ansichten aus:
...
3. Stellen Sie sicher, dass in der oberen rechten Ecke
    **Bearbeitungsmodus** angezeigt wird

    ![](../media/lab-6/image18.png)

4. Das erste Schritt besteht darin, Beziehungen zwischen diesen
    Tabellen zu erstellen.

    ![](../media/lab-6/image19.png)

5. Erstellen wir jetzt eine Beziehung zwischen den Tabellen „Sales" und
...
6. Das Dialogfeld „Neue Beziehung" wird geöffnet. Vergewissern Sie
    sich, dass unter **Von Tabelle** **Sales** und bei **Spalte**
    **ResellerID** angegeben ist.

7. Vergewissern Sie sicher, dass unter **In Tabelle** **Reseller** und
...
11. Erstellen wir auf diese Weise auch eine Beziehung zwischen den
...
12. Das Dialogfeld „Neue Beziehung" wird geöffnet. Vergewissern Sie
    sich, dass unter **Von Tabelle** **Sales** und bei **Spalte**
    **InvoiceDate** angegeben ist.

13. Vergewissern Sie sich, dass unter **In Tabelle** **Date** und bei
