...
3. Under the **Get Data (3)** section, select **Dataflow Gen2 (4).**
    ...
    Leave the default name and select **Create.** You will be navigated to
    the **Dataflow page**. The Dataflow Gen2 interface is like Power Query
    in Power BI Desktop. We can copy queries from Power BI Desktop into
    Dataflow Gen2. Let's give this a try.
...
connection](../media/lab-4/image11.png)
...
10. Select **Save settings**.
    ...
    ![A screenshot of a
computer](../media/lab-4/image16.png)
...
1. Select **Settings** (While the Dataflow is running you
...
6. Once done, close out of the settings window **(3)**.
    ...
    ![A screenshot of a computer](../media/lab-4/image19.png)
...
3. Under Recommended items, select **Dataflow Gen2 (3)**.
    ...
    Leave the default name and select **Create,** if you receive a message
    stating "A dataflow with this name already exists" then change the name
    to **Dataflow 2.** You will be navigated to the **Dataflow page**. Now
    that we are familiar with Dataflow, let's go ahead and copy the queries
    from Power BI Desktop into Dataflow.
...
7. **Right click** and select **Copy**.
    ...
    ![A screenshot of a computer](../media/lab-4/image22.png)
...
9. In the **Dataflow pane** select the **center pane**, enter **Ctrl+V** (currently right click Paste is not supported). If you are using MAC device, please use Cmd+V to paste.
    ...
    **enable** **VM Native Clipboard**. Select OK in the dialog. Once done
    ...
    ![A screenshot to enable copy option in environment](../media/lab-4/image23.png)
...
2. From the ribbon select **Home (2) -> Add data destination (3) ->
    ...
    ![A screenshot of a
computer](../media/lab-4/image26.png)

3. Connect to data destination dialog opens. From the **Connection
    dropdown** select **Lakehouse odl_user_<inject key="Deployment ID" enableCopy="false"/> (none)**.
...
11. You will be navigated back to the **Power Query window**. Notice on
    ...
    **Lakehouse**. Similarly, **set up the Data Destination for PO
    ...
    ![A screenshot of a
computer](../media/lab-4/image30.png)
...
2. Select **New Shortcut**.
    ...
    ![A screenshot of a
computer](../media/lab-4/image35.png)
...
4. **Select Create new connection (1)**, Connection settings dialog
    opens. Enter **org6c18814a.crm.dynamics.com (2**) as **Environment
    domain**.
...
2. Select **New Shortcut**.
    ...
    ![A screenshot of a computer](../media/lab-4/image35.png)

3. New shortcut dialog opens. Select **Microsoft OneLake** option under Internal sources.

    ![A screenshot of a computer](../media/lab-4/image40.png)
...
11. Select **Customer** table to view the data in the preview panel.
    ...
    ![A screenshot of a computer](../media/lab-4/image44.png)
