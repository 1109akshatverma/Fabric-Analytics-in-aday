...
1. Open the **browser** and navigate to [Microsoft Power BI
...
3. On the **Sign into Microsoft Azure** tab you will see the login
    ...
    - **Email/Username:** <inject key="AzureAdUserEmail"></inject>
      ...
      ![A screenshot of a computer](../media/lab-2/image7.png)
...
6. Click on **Advanced** to expand the section.
    ...
    ![A screenshot of a
    computer](../media/lab-2/image14.png)
...
2. You will be directed to the Real-Time Intelligence Home page. Below
    ...
    **Item types:**
    ...
    g. **Digital Twin Builder (Preview):** Digital twin builder equips
    ...
    h. **Map (preview):** Bring geospatial insights into Real-Time
    ...
    **Get Started:**
    ...
    c. **Explore a Eventhouse Sample**: Click on the "Select" button to
...
2. You will be directed to the **Data Engineering** Home page. Below is
    ...
    **Get Started:**
    ...
    ![A screenshot of a computer](../media/lab-2/image28.png)
...
1. From the **Workloads** page, click on **Data Warehouse** to
    ...
    ![A screenshot of a computer](../media/lab-2/image31.png)
...
2. You will be directed to the Data Warehouse Home page. Below is a
    ...
    **Item types:**
    ...
    l. **Mirrored Azure SQL Managed Database**: Used to mirror Azure SQL
...
1. From the **Workloads** page, click on **Databases** to proceed.
    ...
    ![A screenshot of a computer error](../media/lab-2/image33.png)
...
2. You will be directed to the Databases Home page. Below is a detailed overview of its sections, designed to help you use Databases effectively.
    ...
    **Item types:**
    ...
    a. **SQL database (preview)**: SQL database in Fabric is part of
    ...
    b. **Cosmos DB (Preview):** Cosmos DB in Microsoft Fabric is an
    AI-optimized NoSQL database with a simplified management experience.
    As a developer, you can use Cosmos DB in Fabric to build AI
    applications with less friction and without having to take on
...
![A screenshot of help options](../media/lab-2/image35.png)
