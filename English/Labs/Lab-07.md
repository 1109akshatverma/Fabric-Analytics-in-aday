# ![](images7/media/image4.png)r {#r .TOC-Heading}
...
[3](#task-1-auto-create-report)](#task-1-auto-create-report)

[Task 2: Configure background for a New report
[7](#task-2-configure-background-for-a-new-report)](#task-2-configure-background-for-a-new-report)

[Task 3: Add Header to the report
[9](#task-3-add-header-to-the-report)](#task-3-add-header-to-the-report)

[Task 4: Add KPIs to the report
[10](#task-4-add-kpis-to-the-report)](#task-4-add-kpis-to-the-report)

[Task 5: Add Line chart to the report
[14](#task-5-add-line-chart-to-the-report)](#task-5-add-line-chart-to-the-report)

[Task 6: Save the report
[15](#task-6-save-the-report)](#task-6-save-the-report)

[Task 7: Configure Year column in Date table
[15](#task-7-configure-year-column-in-date-table)](#task-7-configure-year-column-in-date-table)

[Task 8: Configure Month Name column in Date table
[18](#task-8-configure-month-name-column-in-date-table)](#task-8-configure-month-name-column-in-date-table)

[Task 9: Format Line chart
[20](#task-9-format-line-chart)](#task-9-format-line-chart)

[Task 10: Connect Power BI Desktop to Semantic model
[21](#task-10-connect-power-bi-desktop-to-semantic-model)](#task-10-connect-power-bi-desktop-to-semantic-model)

[Task 11: Add new data to simulate Direct Lake Mode
[25](#task-11-add-new-data-to-simulate-direct-lake-mode)](#task-11-add-new-data-to-simulate-direct-lake-mode)

[Clean up Lab environment
[33](#clean-up-lab-environment)](#clean-up-lab-environment)

[References [35](#references)](#references)
...
1.  Let's navigate back to the **Fabric workspace** you created in lab
    2, named **FAIAD\_\<username\>**.

2.  From the bottom of the left panel select **Fabric experience
    selector** icon.

![A screen shot of a
computer](images7/media/image6.png)

3.  Fabric experience dialog opens. Select **Power BI**. You will be
    navigated to **Power BI Home page**.

![A screenshot of a
computer](images7/media/image7.png)

4.  Select **New Report** from the top menu.

![A green and white sign with black
text](images7/media/image8.png)

5.  You will be navigated to **Build your first report screen**. There
    will be options to build a report using excel, csv, enter data
    manually or to pick a published semantic model. We have created a
    semantic model in the previous labs so let's use that. Select **Pick
    a published semantic model** option.

![](images7/media/image9.png)

6.  Pick a dataset to use in your report when the page opens. Notice we
    have multiple options. **Select sm_FAIAD**.

    a.  **sm_FAIAD:** This is the semantic model we have created and
        want to use to build the report.

    b.  **lh_FAIAD:** This is the lakehouse where we ingested all the
        data into.

    c.  **Units by Supplier:** This is the dataset we created using
        T-SQL.
...
incorrect.](images7/media/image10.png)
...
![A screenshot of a
computer](images7/media/image11.png)
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image12.png)**\
...
![A screenshot of auto-created
report](images7/media/image13.png)

### Task 2: Configure background for a New report

Let's create a new report using a blank canvas.

1.  In the **left panel**, select your workspace name,
    **FAIAD\_\<username\>** to be navigated to the workspace.

2.  From the top menu, select **New item -\> Report**. You will be
    navigated to build your first report page.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image14.png)

3.  Select **Pick a published semantic model,** so we can pick the model
    we have created.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image15.png)
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image16.png)
...
![A screenshot Power BI Desktop
report](images7/media/image17.png)
...
![A screenshot of a
computer](images7/media/image18.png)
...
4.  Highlight **Fabrikam Company** and set **Font** to **Segoe UI** and
    **font size** to **18, bold**.

5.  Highlight **Sales Report** and set **Font** to **Segoe UI** and
    **font size** to **14.**

6.  With the **text box selected**, in the Format text box pane on the
    right, **expand Effects**.
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image19.png)
...
5.  With the **Card visual selected**, select **Format visual** **icon**
    from **Visualizations** section.
...
8.  With the **Callout** section still selected, expand **Label**
    section.
...
18. Resize the **visual** and move it to the **left box as shown in the
    screenshot**.

![](images7/media/image24.png)

19. Let's add another card. Select the **Sales Card** we just created.
    **Copy** the visual by selecting **Ctrl+C** from your keyboard.

20. **Paste** the visual by selecting **Ctrl+V** from your keyboard.
    Notice the visual is pasted onto the canvas.

21. With the **new visual highlighted**, in the **Visualization pane -\>
    Build visual -\> Fields** section remove **Sales** measure.

22. From the **Data** section, expand **Sales** table and select
    **Units** measure.

23. Resize the **visual** and **place it in the box below the Sales
    visual**.
...
![A screenshot of a
computer](images7/media/image26.png)
...
2.  Save your report dialog opens. Name the report as
    **rpt_Sales_Report**\
    **Note:** We are prefixing report name with rpt which is short for
    report.
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image27.png)
...
![A screenshot of a
computer](images7/media/image29.png)
...
![A screenshot of a computer](images7/media/image30.png)

### Task 8: Configure Month Name column in Date table

1.  Let's add Month to this chart. From the Date table, drag
    **MonthNameShort** field below **Year** in the **X-axis**. Notice
    the visual is sorted by Sales. Let's sort it by **MonthNameShort**.
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image31.png)

**Note:** The months are sorted alphabetically. Let's fix this.

![A screenshot of line
chart](images7/media/image32.png)

6.  Navigate back to the **browser window/tab** where you have the
    semantic model open.
...
![A screenshot of a
computer](images7/media/image33.png)
...
incorrect.](images7/media/image34.png)
...
5.  With the **Line chart visual selected**, in the **Data section**
    expand **Reseller** table.

6.  Drag **Reseller -\> Reseller Company** field to the **Legend**
    section.

![A screenshot of a
computer](images7/media/image35.png)

7.  With the **Line chart visual selected**, from the **Visualization**
    section select **Format visual icon -\> General**.
...
![A screenshot of a
computer](images7/media/image36.png)

12. From the **Visualization** section select **Format visual icon -\>
    Visual**.

13. Expand **Lines** section.

14. In the **Apply settings to -\> Series dropdown,** select **Tailspin
    Toys.**
...
17. In the **Apply settings to -\> Series dropdown,** select **Wingtip
    Toys.**

18. Set **color** to **#004753**

19. Resize the **visual** and move it to the **top right box as shown in
    the screenshot**.

20. Scroll to the right on the visual and **notice we have data through
    April 2024**.

![A screenshot of a
computer](images7/media/image37.png)
...
![A screenshot of a
computer](images7/media/image38.png)

3.  OneLake data hub dialog opens. Select **sm_FAIAD**, the semantic
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image39.png)

5.  From the **left panel**, select **Model view**. Notice we can view
    the relationship between tables.

![A screenshot of a
computer](images7/media/image40.png)

6.  From the **left panel**, select **Report view** to navigate back to
    the Report view.

7.  If you have not already done so, open the **FAIAD.pbix** located
    **Reports** folder on the **desktop** of your lab environment.
...
![A screenshot of a
computer](images7/media/image41.png)
...
16. From the ribbon, select **Home -\> Paste**. Notice that the visual
    does not render. This is because currently the semantic model does
    not create hierarchy from date field.

17. Let's fix this. In **Visualization** panel, under **X-axis** delete
    **StartOfMonth**.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image44.png)

18. From the **Data pane**, expand **Date** table.

19. Drag **StartOfMonth** field into **X-axis**. This fixes the visual.
    You may have to format the visual.

![A blue line graph on a white
background](images7/media/image45.png)
...
2.  In the bottom right corner, click the **Fabric logo** and switch to
    the **Fabric view**.

3.  Select **FAIAD\_\<username\>** from the left menu bar to navigate to
    workspace home.

4.  Select **lh_FAIAD** to navigate into the Lakehouse.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image46.png)

5.  From the **Explorer pane** on the left, select the **ellipsis** next
    to **Tables**.

6.  Select **New shortcut**.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image47.png)

7.  New shortcut dialog opens. Under **External sources**, select
    **Azure Data Lake Storage Gen2**.

![](images7/media/image48.png)

8.  Since you created a connection earlier in the labs, you do not need
    to create a new connection and you will see your ADLS connection
    under existing connections.

9.  If you did not create this connection earlier in the course, click
    **Create New connection** and complete the following steps:

10. Under **Connection Settings -\> URL** enter this link
    <https://stvnextblobstorage.dfs.core.windows.net/>fabrikam-sales

11. Select **Next**.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image49.png)

12. You will be connected to ADLS Gen2 with the directory structure
...
![A screenshot of a
computer](images7/media/image50.png)

15. You will be navigated to the next dialog where we can edit the
    names. Select the **Edit icon** under Actions for
    **Sales.Invoices_May**.
...
![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image51.png)

Notice in the **Explorer pane** on the left, we now have the InvoicesMay
table. Now we need to update the Sales view.

19. On the **top right** of the screen, select **Lakehouse -\> SQL
    analytics endpoint**.

![A screenshot of a
computer](images7/media/image52.png)

20. From the top menu, select **Home -\> New SQL query**. A new SQL
    query pane opens.

21. **Copy** the below code and **paste** it into the SQL query
    pane**.**
...
![A screenshot of New SQL query
editor](images7/media/image53.png)

23. Select **rpt_Sales_Report** from the left menu bar to navigate back
    to the report**.**

24. From the top menu select the **Refresh Icon**. Notice now in the
    Line chart there is data for May 2024. Also, notice the Sales amount
    has increased.
...
- **You need to refresh your dataset at least three times a day to
  accommodate the different update times for the different data
  sources.**
...
- **Your refresh operations take a long time as you need to do a full
  refresh every time to capture any updates that happened to the source
  systems.**
...
- **Any errors in any of the data sources that you are pulling from will
  ...
  file doesn't upload on time resulting in your dataset refresh
  breaking.**

Pipelines help to solve this problem, by providing the ability to retry
refresh on failure and at different intervals.
...
1.  Select **FAIAD\_\<username\>** workspace from the left panel to
    navigate to the workspace home.

2.  From the top menu, select **Workspace settings**.

![A screenshot of a computer AI-generated content may be
incorrect.](images7/media/image55.png)
...
generated](images7/media/image56.jpeg)
...
options](images7/media/image57.png)
