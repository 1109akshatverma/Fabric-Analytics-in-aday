# ![](images2/media/image4.png) {#section .TOC-Heading}

# Contents  {#contents .TOC-Heading}

[Introduction [3](#introduction)](#introduction)

[Fabric License [3](#fabric-license)](#fabric-license)

[Task 1: Enable a Microsoft Fabric trial license
[3](#task-1-enable-a-microsoft-fabric-trial-license)](#task-1-enable-a-microsoft-fabric-trial-license)

[Fabric Workspace [7](#fabric-workspace)](#fabric-workspace)

[Task 2: Create a Fabric Workspace
[7](#task-2-create-a-fabric-workspace)](#task-2-create-a-fabric-workspace)

[Task 3: Create a Lakehouse
[9](#task-3-create-a-lakehouse)](#task-3-create-a-lakehouse)

[Overview of Fabric Experiences
[11](#overview-of-fabric-experiences)](#overview-of-fabric-experiences)

[Task 4: Data Factory Experience
[11](#task-4-data-factory-experience)](#task-4-data-factory-experience)

[Task 5: Industry Solutions Experience
[14](#task-5-industry-solutions-experience)](#task-5-industry-solutions-experience)

[Task 6: Real-Time Intelligence Experience
[17](#task-6-real-time-intelligence-experience)](#task-6-real-time-intelligence-experience)

[Task 7: Data Engineering Experience
[19](#task-7-data-engineering-experience)](#task-7-data-engineering-experience)

[Task 8: Data Science Experience
[21](#task-8-data-science-experience)](#task-8-data-science-experience)

[Task 9: Data Warehouse Experience
[23](#task-9-data-warehouse-experience)](#task-9-data-warehouse-experience)

[Task 10: Databases Experience
[25](#task-10-databases-experience)](#task-10-databases-experience)
...
this workshop, you will learn how to use Lakehouse, Dataflow Gen2,
...
1.  Select **PowerBI Portal** in the Desktop of the Virtual Machine. You
    may be prompted to sign in.

![](images2/media/image6.png){width="2.555686789151356in"
height="2.8543132108486438in"}

**\
*Note:*** *If you\'re using the lab environment, it may sign you in
automatically.**\***

***Note:** If Fabric does not open navigate to
http://app.fabric.microsoft.com/ in the browser.\*

2.  Copy the Username and paste it into the Email field of the dialog
    and select Submit.

    - **Email/Username:** Found in the Environment Tab

![A screenshot of create account
page](images2/media/image7.png){width="3.5641786964129483in"
height="3.053229440069991in"}
...
![A screenshot of a
computer](images2/media/image8.png){width="3.814391951006124in"
height="3.1391305774278213in"}

4.  Now enter the following **Temporary Access Pass** and click on
    **Sign in.**

    - **Temporary Access Pass:** Found in Environment Tab

![](images2/media/image9.png){width="4.472451881014873in"
...
trial](images2/media/image10.png){width="5.637245188101487in"
height="1.7734251968503938in"}
...
screen](images2/media/image11.png){width="4.295651793525809in"
height="4.16439523184602in"}

10. Successfully upgraded to Microsoft Fabric dialog opens. Select
    **Fabric Home Page**.

![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image12.png){width="5.8137992125984255in"
height="2.2536636045494314in"}
...
11. You will be navigated to the **Microsoft** **Fabric Home page**. A
    ...
    you can select either the **Start tour** option or **Cancel**.

![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image13.png){width="6.5in"
height="5.8284722222222225in"}
...
2.  Click **+ New workspace** (2) found at the bottom of the pop-out
    ...
    \
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image14.png){width="1.7168153980752405in"
    height="4.887923228346457in"}
...
6.  Click on **Advanced** to expand the section.\
    ![A screenshot of a
    computer](images2/media/image15.png){width="2.2485936132983375in"
    height="3.4371358267716534in"}
...
8.  Select **Apply** to create a new workspace.\
    \
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image16.png){width="2.859575678040245in"
    height="2.8749496937882766in"}
...
the Lakehouse to build our model and report on it. The first step is to
create a Lakehouse. We will do this next.
...
incorrect.](images2/media/image17.png){width="6.5in"
...
3.  A new lakehouse dialog will appear. Enter **lh_FAIAD** in the Name
    ...
    ***Note:** lh here refers to Lakehouse. We are prefixing lh so that
    ...
    \
    **Note:** The preview feature **Lakehouse Schemas** is very
    interesting and is something you should be aware of. Since it is in
    **Preview** state, we will ignore it so there is no negative impact
    on the lab experience. Once the feature is general available we will
    bring it into this lab.\*

4.  Select **Create**\
    \
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image18.png){width="3.55257874015748in"
...
name in the header, you will have the Lakehouse icon. The workspace icon
on the left navigation will reflect that it now contains an item

Within the Lakehouse Explorer, you will notice a Tables and Files
section. A Lakehouse could expose Azure Data Lake Storage Gen2 files
under the files section, or a dataflow could load data to Lakehouse
tables. There are various options available. We are going to show you
some of the options in the following labs.

![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image19.png){width="2.5383595800524934in"
height="5.521119860017498in"}
...
![](images2/media/image20.png){width="6.5in" height="3.5375in"}

2.  Select **Data Factory**.

![](images2/media/image21.png){width="6.5in" height="3.19375in"}
...
g)  **Mirrored SAP (preview):** Seamlessly integrate your existing SAP
    estate with the rest of your data in Fabric.

h)  **Mirrored Oracle (preview):** Mirroring in Fabric replicates your
    Oracle databases into a unified platform, enabling near real-time,
    low-latency analysis alongside other data sources.

i)  **Mirrored Google Big Query (preview):** Mirroring in Fabric lets
...
j)  **Variable library**: contains a list of variables and their default
    values. It can also contain other value sets holding alternate
    values
...
c)  **Create Your First Pipeline**: This section guides you on how to
    create your first pipeline. Pipelines help automate and manage your
...
![](images2/media/image22.png){width="6.5in"
...
4.  Click on **Return to workloads** at the top left corner of the
    ...
    incorrect.](images2/media/image23.png){width="2.6in"
...
1.  From the **Workloads page**, click on **Industry** Solutions to
    ...
    \
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image24.png){width="6.496692913385827in"
    height="5.282729658792651in"}
...
2.  You will be directed to the Industry Solutions Home page. Below is a
    ...
    Solutions effectively and step-by-step.\
    \
...
b)  **Get started with Healthcare data solutions**: Start deploying
    healthcare data solutions and implement them in your projects.
...
d)  **Get started with Sustainability solutions**: Start deploying
    sustainability solutions and implement them in your projects.

e)  **Learn About Retail Solution**s: Click on the \"Learn more\" button
    to read about retail solutions and understand how they can be used
    in your projects.

f)  **Get started with Retail solutions**: Start deploying retail
    solutions and implement them in your projects.**\**

![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image25.png){width="6.208871391076116in"
...
1.  From the **Workloads** page, click on **Real-Time Intelligence** to
    proceed.\
    \
    ![](images2/media/image26.png){width="6.5in"
...
2.  You will be directed to the Real-Time Intelligence Home page. Below
    ...
    Real-Time Intelligence effectively and step-by-step.
...
>
> f\. **Event Schema Set (preview):** Help you organize and standardize
> data structures (schemas) for your real-time analytics workflows,
> making it easier to process and analyze streaming data consistently.
>
> g\. **Anomaly detector (Preview):** Anomaly detection automatically
> identifies unusual patterns and outliers in your Event house tables.
>
> h\. **Operations agent (Preview):** Operation agents automate the
> observe -\> analyze -\> decide -\> act cycle. They continuously track
> key metrics, surface insights, and recommend targeted actions.
>
> i\. **Map (preview):** Bring geospatial insights into Real-Time
> Intelligence, enabling anyone to visualize where events happen,
> integrate spatial data with other Fabric capabilities, and make
> smarter, location-aware decisions.
>
> j\. **Digital Twin Builder (Preview):** Digital twin builder equips
> users with low code/no code experiences to build and model their
> business concepts, such as assets and processes, through an ontology.\
> \
> **Get Started:\**
...
> started\" button to explore real-time data analysis with sample data
> sets.
>
> b\. **Explore Real-Time Intelligence Sample**: Click on the \"Open\"
> button to explore real-time data analysis with a sample.

c\. **Explore an Eventhouse Sample**: Click on the \"Select\" button to
use a sample and learn about Real-Time Intelligence.

d\. **Introduction to Real-Time Intelligence**: Click on the \"Open\"
button to get an overview of Real-Time Intelligence and begin using the
tool effectively.

e\. **Learn KQL with Sample Data**: Click on the \"Open\" button to
learn KQL using sample data.

f\. **What\'s a Real-Time Hub**: Click on the \"Open\" button to learn
what a Real-Time Hub is and how it can be used.

g\. **Explore a Sample Activator**: Click on the \"Open\" button to use
a sample activator and understand the features and capabilities of
Real-Time Intelligence.

h\. **Get Started with Activator**: Click on the \"Open\" button to get
started with activator concepts and begin using the tool effectively.\
\
![](images2/media/image27.png){width="6.5in"
...
1.  From the **Workloads** page, click on Data Engineering to proceed.\
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image28.png){width="5.7262095363079615in"
    height="2.964047462817148in"}
...
2.  You will be directed to the **Data Engineering** Home page. Below is
    ...
    Engineering** effectively and step-by-step.\
    \
...
e\. **User data functions**: platform that allows you to host and run
...
1.  From the **Workloads** page, click on **Data Science** to proceed.\
    \
    ![A screenshot of a computer AI-generated content may be
    incorrect.](images2/media/image30.png){width="6.5in"
...
d\. **Get Started with Notebooks**: Click on the \"Open\" button to
...
\
![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image31.png){width="6.807490157480315in"
height="3.6815715223097114in"}
...
1.  From the **Workloads** page, click on **Data Warehouse** to
    proceed.\
    ![A screenshot of a
    computer](images2/media/image32.png){width="6.25336176727909in"
    height="1.6635542432195976in"}
...
2.  You will be directed to the Data Warehouse Home page. Below is a
    ...
    **What is Data Warehouse?\
    ...
    benefiting from top-tier performance at petabyte scale in an
    open-data format.
...
h\. **Mirrored Google Big Query (preview):** Used to mirror Google Big
Query.

i\. **Mirrored Azure Cosmos DB**: Used to mirror Azure Cosmos DB.

j\. **Mirrored SQL Server (preview):** Used to mirror SQL Server.

k\. **Mirrored Azure Database for PostgreSQL (preview):** Used to mirror
your existing Azure Database for PostgreSQL\
\
l. **Mirrored Azure SQL Managed Instance**: Used to mirror Azure SQL
Managed Databases for high availability and disaster recovery.

m\. **Mirrored Database (preview)**: Used to replicate databases for
...
![A screenshot of a computer AI-generated content may be
incorrect.](images2/media/image33.png){width="6.1296981627296585in"
...
1.  From the **Workloads** page, click on **Databases** to proceed.\
    \
    ![A screenshot of a computer
    error](images2/media/image34.png){width="2.0884536307961503in"
    height="1.2642268153980751in"}
...
2.  You will be directed to the Databases Home page. Below is a detailed
    ...
    **What is a Fabric Database?\
    \**
    SQL database in Microsoft Fabric is a developer-friendly
    transactional database, based on Azure SQL Database, that allows you
    to easily create your operational database in Fabric. A SQL database
    in Fabric uses the same SQL Database Engine as Azure SQL Database.\
    \
    **Item types:\
    \**
    a. **SQL database**: SQL database in Fabric is part of
    the Database workload, and the data is accessible from other items
    in Fabric. Your SQL database data is also kept up-to-date in a
    queryable format in OneLake, so you can use all the different
    services in Fabric, such as running analytics with Spark, executing
    notebooks, data engineering, visualizing through Power BI Reports,
    and more.\
    \
    b. **Cosmos DB:** Cosmos DB in Microsoft Fabric is an AI-optimized
    NoSQL database with a simplified management experience. As a
    developer, you can use Cosmos DB in Fabric to build AI applications
    with less friction and without having to take on typical database
    management tasks.**\**
...
\
![](images2/media/image35.png){width="6.5in"
...
options](images2/media/image36.png){width="1.8736504811898513in"
