...
3. Você verá três elementos associados a lh_FAIAD -- Lakehouse, Modelo
    ...
    A segunda opção é escrever código T-SQL. É uma opção conveniente para
...
2. No menu do painel Resultados, selecione o ícone suspenso **->
...
1. Selecione o **Lakehouse** a ser navegado para a exibição Lakehouse
    de ponto de extremidade de análise de SQL.

    ![](../media/lab-6/image13.png)

2. No menu, selecione **Novo modelo semântico**.

    ![](../media/lab-6/image14.png)

3. A caixa de diálogo Novo modelo semântico é aberta. Insira
    **sm_FAIAD** como o nome do modelo semântico Direct Lake.

4. Temos a opção de selecionar um subconjunto de tabelas por padrão.
...
5. **Selecione** as seguintes tabelas/exibições:
...
6. Selecione **Confirmar.**
    ...
    Você será direcionado até o novo modelo semântico com as tabelas
    selecionadas. Você pode **reorganizar** as tabelas conforme necessário.
    Observe que algumas tabelas (Geo, Reseller, Sales e Product) têm um
    sinal de aviso no canto superior direito da tabela. Isso porque são
    exibições. Todos os elementos visuais criados com campos dessas
    exibições estarão no modo Direct Query e não no modo Direct Lake.
...
Se você não está atualmente dentro do modelo semântico recém-criado,
vamos ao lugar certo
...
3. No canto superior direito, verifique se você está no modo
    **Edição**.

    ![](../media/lab-6/image19.png)

4. A primeira etapa é criar relacionamentos entre essas tabelas.

    ![](../media/lab-6/image20.png)

5. Vamos criar um relacionamento entre as tabelas Sales e Reseller.
    Selecione **ResellerID** na tabela **Sales** e arraste-o para
    **ResellerID** na tabela **Reseller**.

    ![](../media/lab-6/image21.png)

6. A caixa de diálogo Novo relacionamento é aberta. Verifique se a
...
11. Da mesma forma, crie um relacionamento entre as tabelas Sales e
    Date. Selecione **InvoiceDate** na tabela **Sales** e arraste-o para
    **Date** na tabela **Date**.

12. A caixa de diálogo Novo relacionamento é aberta. Verifique se a
...
17. De maneira similar, crie um relacionamento **muitos para um** entre
