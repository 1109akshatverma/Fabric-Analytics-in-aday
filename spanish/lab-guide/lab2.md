...
6. Asumimos que está familiarizado con el diseño del servicio Power BI.
    ...
    Actualmente, se encuentra en **Mi área de trabajo**. Para trabajar con
    elementos de Fabric, necesitará una licencia de prueba y un área de
    trabajo que tenga una licencia de Fabric asignada. Configurémoslo.
...
11. Se le dirigirá a la **página Inicio de Microsoft Fabric**. Es
    posible que se abra un cuadro de diálogo "Le damos la bienvenida a
    la vista de Fabric". Si lo desea, puede seleccionar la opción
    **Iniciar recorrido** o **Cancelar**.
...
8. Seleccione **Aplicar** para crear un nuevo área de trabajo.
    ...
    paso es crear un almacén de lago de datos y lo haremos a continuación.
...
2. Se le dirigirá a la página principal de Data Warehouse. A
    continuación se muestra una descripción detallada de sus secciones,
    diseñadas para ayudarlo a usar Data Warehouse de manera efectiva
    y paso a paso.
...
una licencia que obligue a Microsoft a conceder su software
o documentación bajo licencia a terceras partes porque incluyamos sus
