...
2. En el menú del panel Resultados, seleccione el icono desplegable ->
...
1. Seleccione **Almacén de lago** para ir a la vista de Almacén de lago
    en el punto de conexión de análisis SQL.

    ![](../media/lab-6/image13.png)

2. En el menú superior, seleccione **Nuevo modelo semántico.**

    ![](../media/lab-6/image14.png)

3. Se abre el cuadro de diálogo Nuevo modelo semántico. Escriba
    **sm_FAIAD** como nombre del modelo semántico de Direct Lake.

4. Tenemos la opción de seleccionar un subconjunto de las tablas de
...
5. **Seleccione** las siguientes tablas/vistas:
...
DE AUSENCIA DE INFRACCIÓN. MICROSOFT NO DECLARA NI GARANTIZA LA
EXACTITUD DE LOS RESULTADOS, EL RESULTADO DERIVADO DE LA REALIZACIÓN
DE LA DEMOSTRACIÓN/LABORATORIO PRÁCTICO NI LA IDONEIDAD DE LA
INFORMACIÓN CONTENIDA EN ELLA CON NINGÚN PROPÓSITO.
