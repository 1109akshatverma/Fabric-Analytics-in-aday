# Microsoft Fabric Analyst in a Day - 랩 6
...
2. 결과 창 메뉴에서 드롭다운 아이콘 -**> 결과 시각화** 를 선택합니다.
...
1. SQL 분석 엔드포인트에서 레이크하우스 뷰로 이동하려면 **레이크하우스** 를 선택합니다.

    ![](../media/lab-6/image14.png)

2. 메뉴에서 **새 의미 체계 모델** 을 선택합니다.

    ![](../media/lab-6/image15.png)

3. 새 의미 체계 모델 대화 상자가 열립니다. **sm_FAIAD** 를 Direct Lake
    의미 체계 모델 이름으로 입력합니다.

4. 기본적으로 테이블의 하위 집합을 선택할 수 있는 옵션이 있습니다. 이전
...
새로 생성된 의미 체계 내에 있지 않다면, 올바른 위치로 이동해 보겠습니다.
...
3. 오른쪽 위 모서리에서 **편집** 모드에 있는지 확인합니다

    ![](../media/lab-6/image20.png)

4. 첫 번째 단계는 이러한 테이블 간에 관계를 만드는 것입니다.

    ![](../media/lab-6/image21.png)

5. Sales 테이블과 Reseller 테이블 간의 관계를 만들어 보겠습니다.
    **Sales** 테이블에서 **ResellerID** 를 선택하여 **Reseller** 테이블의
    **ResellerID** 로 드래그합니다.

    ![](../media/lab-6/image22.png)

6. 새 관계 대화 상자가 열립니다. **테이블에서** 가 **Sales** 이고
    **열** 이 **ResellerID** 인지 확인합니다.

7. **테이블로** 가 **Reseller** 이고 **열** 이 **ResellerID** 인지
    확인합니다.

8. **Cardinality** **다대일(*:1)** 인지 확인합니다.

9. **교차 필터 방향**이 **Single** 인지 확인합니다.

10. **저장** 을 선택합니다.

    ![](../media/lab-6/image23.png)

11. 마찬가지로 Sales 테이블과 Date 테이블 간의 관계를 만듭니다.
    **Sales** 테이블에서 **InvoiceDate** 를 선택하여 **Date** 테이블의
    **Date** 로 드래그합니다.

12. 새 관계 대화 상자가 열립니다. **테이블에서** 가 **Sales** 이고
    **열** 이 **InvoiceDate** 인지 확인합니다.

13. **테이블로** 가 **Date** 이고 **열** 이 **Date** 인지 확인합니다.

14. **Cardinality** **다대일(*:1)** 인지 확인합니다.

15. **교차 필터 방향** 이 **Single** 인지 확인합니다.

16. **저장** 을 선택합니다.

    ![](../media/lab-6/image24.png)

17. 비슷하게, **Sales** 와 **Product** 테이블 사이에 **다대일** 관계를
...
22. **테이블로**가 **Reseller** 이고 **열**이 **ResellerID** 인지
    확인합니다.
